...
def get_default_settings():
    ...
    return {
        ...
        "lspr_default_prediction_model": "auto",
        "lspr_default_generator_model": "auto",
...
def _migrate_legacy_lspr_settings(settings):
    ...
    if lowered in _LEGACY_BACKEND_MODES:
        ...
        migrated.setdefault("lspr_default_prediction_model", "auto")
        migrated.setdefault("lspr_default_generator_model", "auto")
    else:
        migrated.setdefault("lspr_backend_mode", "auto")
        migrated.setdefault("lspr_default_inference_model", legacy_mode_str)
        migrated.setdefault("lspr_default_prediction_model", legacy_mode_str)
        migrated.setdefault("lspr_default_generator_model", "auto")
    return migrated
