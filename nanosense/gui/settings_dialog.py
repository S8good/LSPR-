...
class SettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.lspr_default_prediction_model_combo = QComboBox()
        self.lspr_default_prediction_model_combo.addItem("Auto", "auto")
        self.lspr_default_prediction_model_label = QLabel()
        lspr_layout.addRow(self.lspr_default_prediction_model_label, self.lspr_default_prediction_model_combo)

        self.lspr_default_generator_model_combo = QComboBox()
        self.lspr_default_generator_model_combo.addItem("Auto", "auto")
        self.lspr_default_generator_model_label = QLabel()
        lspr_layout.addRow(self.lspr_default_generator_model_label, self.lspr_default_generator_model_combo)
    ...
    def _retranslate_ui(self):
        ...
        self.lspr_default_prediction_model_label.setText(self.tr("Default Prediction Model:"))
        self.lspr_default_generator_model_label.setText(self.tr("Default Spectrum Generator:"))
    ...
    def _populate_initial_values(self):
        ...
        self.lspr_default_prediction_model_combo.clear()
        self.lspr_default_prediction_model_combo.addItem("Auto", "auto")
        configured_prediction_model = self.settings.get("lspr_default_prediction_model", "auto")
        if configured_prediction_model not in ("", None, "auto"):
            self.lspr_default_prediction_model_combo.addItem(str(configured_prediction_model), str(configured_prediction_model))
        prediction_index = self.lspr_default_prediction_model_combo.findData(configured_prediction_model)
        if prediction_index >= 0:
            self.lspr_default_prediction_model_combo.setCurrentIndex(prediction_index)
        self.lspr_default_generator_model_combo.clear()
        self.lspr_default_generator_model_combo.addItem("Auto", "auto")
        configured_generator_model = self.settings.get("lspr_default_generator_model", "auto")
        if configured_generator_model not in ("", None, "auto"):
            self.lspr_default_generator_model_combo.addItem(str(configured_generator_model), str(configured_generator_model))
        generator_index = self.lspr_default_generator_model_combo.findData(configured_generator_model)
        if generator_index >= 0:
            self.lspr_default_generator_model_combo.setCurrentIndex(generator_index)
    ...
    def _save_and_accept(self):
        ...
        self.settings["lspr_default_prediction_model"] = self.lspr_default_prediction_model_combo.currentData()
        self.settings["lspr_default_generator_model"] = self.lspr_default_generator_model_combo.currentData()
