...
def test_save_lspr_ai_prediction_creates_analysis_run_and_metrics(tmp_path):
    ...
    analysis_run_id = manager.save_lspr_ai_prediction(
        ...
        input_context={
            "requested_prediction_model": "auto",
            "resolved_prediction_model": "v2",
            "requested_generator_model": "stage3_3a_fixed_frozen",
            "resolved_generator_model": "stage3_3a_fixed_frozen",
    ...
    assert '"resolved_prediction_model": "v2"' in row[1]
    assert '"resolved_generator_model": "stage3_3a_fixed_frozen"' in row[1]
